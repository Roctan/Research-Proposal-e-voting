...
export default function Home() {
  ...
  async function getSmartContractAddress() {
    const addr = process.env.NEXT_PUBLIC_SMART_CONTRACT_ADDRESS || "0x04738f89123759B79FCa6dc2757E267FccCF897D";
    ...
    <>
      ...
      <div className={styles.bottomBody}>
        ...
        <footer className={styles.footer2}>
          <p>Capstone Project for the Rohit Tandon x Filecoin Collaboration</p>
